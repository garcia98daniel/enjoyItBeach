    ...
    <div class="box box-primary col-xs-12 restaurant-container " onclick="cargarformulario('productos/'+{{$tienda->id}});">
      ...
      @endforeach
    @else
      <h2>Lo sentimos, No hay Tiendas disponibles en el momento</h2>
    @endif  
